...
// 2) Fetch messages newer than 'since', or last 50 if since is null
if ($sinceTs !== null) {
    $msgSql = "
        SELECT 
            message_id,
            ...
            vanish_mode
        FROM messages
        WHERE chat_id = '$chatIdEsc' AND created_at > $sinceTs
...
// If we used DESC + LIMIT (no sinceTs), reverse to oldest->newest
if ($sinceTs === null) {
...
json_response(true, "Chat updated", $data);
